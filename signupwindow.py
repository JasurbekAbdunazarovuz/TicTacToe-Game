...
class RegistrWindow(QMainWindow):
    ...
    def setupUi(self, MainWindow):
        ...
        self.setWindowIcon(QtGui.QIcon(":/icons/user.png"))
        font = QtGui.QFont()
        ...
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap(":/icons/view.png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
    ...
    def e_s(self):
        if str(self.lineEdit_3.echoMode()) == "EchoMode.Normal":
            ...
            self.pushButton_3.setIcon(QtGui.QIcon(":/icons/view.png"))
            
        else:
            self.lineEdit_3.setEchoMode(QLineEdit.EchoMode.Normal)
            self.pushButton_3.setIcon(QtGui.QIcon(":/icons/private.png"))
